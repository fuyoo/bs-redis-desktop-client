      ...
      <q-card class="q-dialog-plugin">
        ...
        <q-scroll-area class="h-460px">
          <q-form ref="formRef" class="q-gutter-md p-4">
            ...
            <q-input v-model="formModel.node[0].port" filled :label="$t('home.form.lable[2]')"
              :hint="$t('home.form.hint[2]')" />
            <q-input v-model="formModel.node[0].db" filled :label="$t('home.form.lable[3]')"
              :hint="$t('home.form.hint[3]')" />
            <q-input v-model="formModel.node[0].username" filled :label="$t('home.form.lable[4]')"
              :hint="$t('home.form.hint[4]')" />
            <q-input v-model="formModel.node[0].password" filled :label="$t('home.form.lable[5]')"
